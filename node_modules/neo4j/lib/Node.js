/*** Generated by streamline 0.4.3 (callbacks) - DO NOT EDIT ***/ var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename),__func=__rt.__func,__cb=__rt.__cb,__tryCatch=__rt.__tryCatch,__apply=__rt.__apply; (function() {
  ...
  module.exports = Node = (function(_super) {
    ...
    Node.prototype.save = function Node_prototype_save__1(_) { var message, response, services, _ref, _ref1, __this = this; var __frame = { name: "Node_prototype_save__1", line: 30 }; return __func(_, this, arguments, Node_prototype_save__1, 0, __frame, function __$Node_prototype_save__1() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$Node_prototype_save__1() { return (function __$Node_prototype_save__1(__then) {
                ...
                if (__this.exists) {
                  ...
                  return __this.db.getServices(__cb(_, __frame, 20, 21, function ___(__0, __2) { services = __2;
                    return __this._request.post({
                      ...
                      __this._data = response.body; __then(); }, true)); }, true)); } ; })(__then); }); })(function ___(error, __result) { __tryCatch(_, function __$Node_prototype_save__1() { if (error) {
    ...
    Node.prototype["delete"] = function Node_prototype_delete__2(_, force) { var relationship, relationships, _i, _len, __this = this, __arguments = arguments; var __frame = { name: "Node_prototype_delete__2", line: 66 }; return __func(_, this, arguments, Node_prototype_delete__2, 0, __frame, function __$Node_prototype_delete__2() {

        if ((force == null)) {
          force = false; } ;

        if (!__this.exists) { return _(null); } ; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$Node_prototype_delete__2() {



              return __this.all(null, __cb(_, __frame, 9, 24, function ___(__0, __1) { relationships = __1;
                if ((relationships.length && !force)) {
                  return _(new Error((("Could not delete " + __this) + "; still has relationships."))); } ;

                _i = 0; _len = relationships.length; var __5 = false; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$Node_prototype_delete__2() { __more = false; if (__5) { _i++; } else { __5 = true; } ; var __4 = (_i < _len); if (__4) {
                      relationship = relationships[_i];
                      return relationship["delete"](__cb(_, __frame, 15, 10, function __$Node_prototype_delete__2() { while (__more) { __loop(); }; __more = true; }, true)); } else { __break(); } ; }); do { __loop(); } while (__more); __more = true; })(__then); }, true)); }); })(function ___(error, __result) { __tryCatch(_, function __$Node_prototype_delete__2() { if (error) {
    ...
    Node.prototype.createRelationshipTo = function Node_prototype_createRelationshipTo__3(otherNode, type, data, _) { var __this = this; var __frame = { name: "Node_prototype_createRelationshipTo__3", line: 91 }; return __func(_, this, arguments, Node_prototype_createRelationshipTo__3, 3, __frame, function __$Node_prototype_createRelationshipTo__3() {
        return __this._createRelationship(__this, otherNode, type, data, __cb(_, __frame, 1, 13, _, true)); }); };


    Node.prototype.createRelationshipFrom = function Node_prototype_createRelationshipFrom__4(otherNode, type, data, _) { var __this = this; var __frame = { name: "Node_prototype_createRelationshipFrom__4", line: 95 }; return __func(_, this, arguments, Node_prototype_createRelationshipFrom__4, 3, __frame, function __$Node_prototype_createRelationshipFrom__4() {
        return __this._createRelationship(otherNode, __this, type, data, __cb(_, __frame, 1, 13, _, true)); }); };


    Node.prototype._createRelationship = function Node_prototype__createRelationship__5(from, to, type, data, _) { var createRelationshipURL, message, otherNodeURL, relationship, response, _ref, _ref1, __this = this; var __frame = { name: "Node_prototype__createRelationship__5", line: 99 }; return __func(_, this, arguments, Node_prototype__createRelationship__5, 4, __frame, function __$Node_prototype__createRelationship__5() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$Node_prototype__createRelationship__5() {
              ...
              otherNodeURL = to.self; return (function __$Node_prototype__createRelationship__5(__then) {
                if ((((createRelationshipURL != null)) && otherNodeURL)) {
                  return __this._request.post({
                    ...
                    relationship = new Relationship(__this.db, response.body, from, to);
                    return _(null, relationship); }, true)); } else {
    ...
    Node.prototype._getRelationships = function Node_prototype__getRelationships__6(direction, type, _) { var data, prefix, relationships, relationshipsURL, resp, types, _this, __this = this; var __frame = { name: "Node_prototype__getRelationships__6", line: 134 }; return __func(_, this, arguments, Node_prototype__getRelationships__6, 2, __frame, function __$Node_prototype__getRelationships__6() { _this = __this;
        ...
        if ((type != null)) {
          types = ((type instanceof Array) ? type : [type,]); } ; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$Node_prototype__getRelationships__6() {
              ...
              return __this._request.get(relationshipsURL, __cb(_, __frame, 17, 15, function ___(__0, __1) { resp = __1;
                ...
                relationships = data.map(function(data) {
                ...
                return _(null, relationships); }, true)); }); })(function ___(error, __result) { __tryCatch(_, function __$Node_prototype__getRelationships__6() { if (error) {

                return _(adjustError(error)); } else { _(null, __result); } ; }); }); })(function ___() { __tryCatch(_, _); }); }); };



    Node.prototype.getRelationships = function Node_prototype_getRelationships__7(type, _) { var __this = this; var __frame = { name: "Node_prototype_getRelationships__7", line: 172 }; return __func(_, this, arguments, Node_prototype_getRelationships__7, 1, __frame, function __$Node_prototype_getRelationships__7() {
        return __this.all(type, __cb(_, __frame, 1, 13, _, true)); }); };


    Node.prototype.outgoing = function Node_prototype_outgoing__8(type, _) { var __this = this; var __frame = { name: "Node_prototype_outgoing__8", line: 176 }; return __func(_, this, arguments, Node_prototype_outgoing__8, 1, __frame, function __$Node_prototype_outgoing__8() {
        return __this._getRelationships("outgoing", type, __cb(_, __frame, 1, 13, _, true)); }); };


    Node.prototype.incoming = function Node_prototype_incoming__9(type, _) { var __this = this; var __frame = { name: "Node_prototype_incoming__9", line: 180 }; return __func(_, this, arguments, Node_prototype_incoming__9, 1, __frame, function __$Node_prototype_incoming__9() {
        return __this._getRelationships("incoming", type, __cb(_, __frame, 1, 13, _, true)); }); };


    Node.prototype.all = function Node_prototype_all__10(type, _) { var __this = this; var __frame = { name: "Node_prototype_all__10", line: 184 }; return __func(_, this, arguments, Node_prototype_all__10, 1, __frame, function __$Node_prototype_all__10() {
        return __this._getRelationships("all", type, __cb(_, __frame, 1, 13, _, true)); }); };


    Node.prototype.path = function Node_prototype_path__11(to, type, direction, maxDepth, algorithm, _) { var data, end, length, nodes, path, pathURL, relationships, res, start, _this, __this = this; var __frame = { name: "Node_prototype_path__11", line: 188 }; return __func(_, this, arguments, Node_prototype_path__11, 5, __frame, function __$Node_prototype_path__11() { _this = __this;
        ...
        if ((algorithm == null)) {
          algorithm = "shortestPath"; } ; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$Node_prototype_path__11() {
              ...
              return __this._request.post({
                ...
                return _(null, path); }, true)); }); })(function ___(error, __result) { __tryCatch(_, function __$Node_prototype_path__11() { if (error) {

                return _(adjustError(error)); } else { _(null, __result); } ; }); }); })(function ___() { __tryCatch(_, _); }); }); };



    Node.prototype.getRelationshipNodes = function Node_prototype_getRelationshipNodes__12(rels, _) { var resp, traverseURL, _ref, _ref1, _ref2, _this, __this = this; var __frame = { name: "Node_prototype_getRelationshipNodes__12", line: 244 }; return __func(_, this, arguments, Node_prototype_getRelationshipNodes__12, 1, __frame, function __$Node_prototype_getRelationshipNodes__12() { _this = __this;
